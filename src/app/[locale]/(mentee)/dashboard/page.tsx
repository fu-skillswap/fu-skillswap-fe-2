...
export default async function DashboardPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <section className="space-y-6 max-w-2xl mx-auto py-2" aria-label="Community posts">
      ...
      <div
        className="bg-white rounded-3xl p-4 border border-solid border-border-light shadow-xs overflow-hidden"
        aria-label="Community stories & ads"
      >
        <div className="flex items-center gap-4 overflow-x-auto pb-1 scrollbar-none">
          ...
          <div className="flex flex-col items-center gap-1.5 shrink-0 cursor-pointer group">
            ...
            <span className="text-xs font-bold text-text-main text-center truncate max-w-[70px]">
              Tạo tin
            </span>
          </div>
