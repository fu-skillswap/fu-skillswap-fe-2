...
export const demoMentorServices: MentorService[] = [
  {
    ...
    name: "CV Review",
    description:
      "Deep dive into your resume with actionable edits and rewrite suggestions.",
    durationMinutes: 30,
    priceScoins: 150000,
    completedCount: 214,
  },
  {
    ...
    name: "Mock Interview",
    description:
      "Full PM interview simulation with instant feedback and scoring rubric.",
    durationMinutes: 60,
    priceScoins: 300000,
    completedCount: 189,
  },
  {
    ...
    description:
      "Map your path to a PM role with a tailored 3-month action plan.",
    durationMinutes: 45,
    priceScoins: 250000,
    completedCount: 97,
  },
  {
    ...
    description:
      "Review your product case studies and advise on storytelling and impact.",
    durationMinutes: 45,
    priceScoins: 200000,
    completedCount: 76,
  },
...
export function getMentorServices(mentor: Mentor): MentorService[] {
  const seededServices = demoMentorServices.filter(
    (service) => service.mentorId === mentor.id,
  );
