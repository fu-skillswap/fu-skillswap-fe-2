    ...
    <aside className="w-64 bg-slate-950 text-white min-h-screen flex flex-col p-4 shrink-0 border-r border-solid border-slate-800/80 shadow-2xl">
      <div className="flex items-center gap-3 pb-5 mb-3 border-b border-solid border-slate-800/80">
        ...
        <div>
          ...
          <strong className="text-sm font-extrabold text-white block tracking-tight">
            SkillSwap Admin
          </strong>
        </div>
      </div>
      ...
      >
        <Link
          className={
            pathname === dashboardHref
              ? 'flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-extrabold bg-primary text-white shadow-lg shadow-primary/20 transition-all border border-solid border-primary/40'
              : 'flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-semibold text-slate-400 hover:text-white hover:bg-slate-900 transition-all'
          }
          href={dashboardHref}
        >
          <Icon name="grid" />
        ...
        <Link
          className={
            pathname === mentorVerificationHref
              ? 'flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-extrabold bg-primary text-white shadow-lg shadow-primary/20 transition-all border border-solid border-primary/40'
              : 'flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-semibold text-slate-400 hover:text-white hover:bg-slate-900 transition-all'
          }
      ...
      <div className="pt-4 border-t border-solid border-slate-800/80 flex flex-col gap-1.5">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-semibold text-slate-400 hover:text-white hover:bg-slate-900 transition-all"
        >
