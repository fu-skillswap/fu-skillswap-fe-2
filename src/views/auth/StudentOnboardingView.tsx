  ...
  return (
    <AuthGuard locale={locale}>
      <main className="figma-onboarding-page">
        <section
          className="figma-onboarding-card"
        ...
        >
          ...
          {!isCreating ? (
            <>
              <p>
                Tài khoản Google của bạn đã được xác thực, nhưng hồ sơ sinh viên
                chưa hoàn tất. Hãy tạo hồ sơ để tiếp tục sử dụng nền tảng.
              </p>
              <button
